...
const userLoginBody = (firstName,lastName,email) => {
    return `
    ...
    <![endif]-->
      ...
      <title></title>
        ...
        <style type="text/css">
          table, td { color: #000000; } @media (max-width: 480px) { #u_content_text_4 .v-text-align { text-align: center !important; } }
    ...
    * {
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div class="v-text-align" style="line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;"><span style="font-family: Cabin, sans-serif; font-size: 20px; line-height: 28px;">Welcome To Critica ${firstName} ${lastName}<br /></span></p>
      </div>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div class="v-text-align" style="color: #4c5763; line-height: 180%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 180%;">Hello world</p>
      </div>
...
const criticCongratulationBody = (firstName,lastName,email) => `
    <div> ${firstName} ${lastName} You are a Critic Now!</div>
`

const criticRejectionBody = (firstName,lastName,email) => `
    <div> ${firstName} your request is rejected for now, please apply with more background!</div>
`



const getMailBody = (mailType,firstName,lastName,email) => {
    if(mailType === 'user first login'){
        return userLoginBody(firstName,lastName,email)
    }
    else if(mailType === 'critic congratulation'){
        return criticCongratulationBody(firstName,lastName,email)
    }
    else if(mailType === 'critic request reject'){
        return criticRejectionBody(firstName,lastName,email)
    }
    else{
        return "<h2>Hello User From Critica</h2>"
    }
}
